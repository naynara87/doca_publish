$(document).ready(function () {
    ...
    <div class="doca__card">
        ...
        <div class="doca__card-details">
            <h3 class="doca__card-title" title="업무 및 정보기술 요건업무 및 정보기술 요건업무 및 정보기술 요건">업무 및 정보기술 요건업무 및 정보기술 요건업무 및 정보기술 요건</h3>
            ...
            <div class="doca__card-footer">
                ...
                <button class="btn__icon btn__search" title="미리보기" data-toggle="tooltip"><i class="doca-search-line"></i></button>
            </div>
        </div>
    </div>
    `
